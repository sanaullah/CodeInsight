...
async def build_architecture_node(state: SwarmAnalysisState) -> SwarmAnalysisState:
    ...
    try:
        from analysis.agents.architecture_model_builder import ArchitectureModelBuilder
        from infrastructure.utils.knowledge_base import get_architecture_model
        from indexing.scanners.project_scanner import FileInfo
        from infrastructure.utils.langfuse_integration import create_observation, create_llm_observation
        ...
        try:
            ...
            from infrastructure.utils.io.architecture_hash import compute_architecture_hash
            ...
            if arch_obs:
                try:
                    ...
                    try:
                        from infrastructure.utils.langfuse.client import get_langfuse_client
