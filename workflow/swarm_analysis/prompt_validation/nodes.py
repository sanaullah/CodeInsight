...
from workflow.prompt_validation_config import get_prompt_validation_config
...
async def validate_single_prompt_node(state: SwarmAnalysisState, config: Optional[Dict[str, Any]] = None) -> SwarmAnalysisState:
    ...
    from infrastructure.utils.prompts.prompt_validator import PromptValidator, format_shared_validation_results
...
"""
            ...
            if validation_trace_id:
                try:
                    from infrastructure.utils.langfuse.evaluation import score_trace
