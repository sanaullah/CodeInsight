...
def store_prompts_node(state: SwarmAnalysisState) -> SwarmAnalysisState:
    ...
    try:
        from infrastructure.utils.prompts.prompt_storage import save_prompt
        from infrastructure.utils.langfuse_integration import create_langfuse_prompt
        ...
        for role_name in roles_to_process:
            ...
            try:
                ...
                if existing_langfuse_prompt_id and validation_result:
                    ...
                    try:
                        from infrastructure.utils.langfuse.prompts import update_langfuse_prompt_config
                    ...
                    try:
                        ...
                        if langfuse_prompt_result:
                            ...
                            if prompt_id:
                                try:
                                    from infrastructure.utils.prompts.prompt_storage import update_prompt
        ...
        from infrastructure.utils.error_formatting import format_user_error
