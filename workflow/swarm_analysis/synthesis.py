...
from workflow.swarm_analysis_state import SwarmAnalysisState
from workflow.swarm_analysis_state_decorators import validate_state_fields
from workflow.state_keys import StateKeys
from workflow.nodes import llm_node
from infrastructure.utils.error_context import create_error_context
...
async def synthesize_results_node(state: SwarmAnalysisState, config: Optional[Dict[str, Any]] = None) -> SwarmAnalysisState:
    """
    Synthesize results from all analysis.agents.
    ...
    from workflow.swarm_analysis.utils import get_stream_callback
...
"""
        ...
        harmful_section = ""
        try:
            from infrastructure.utils.skill_integration import format_skills_for_prompt, format_harmful_patterns
            from domain.skills import SwarmSkill
            ...
            if synthesis_skills_data:
                ...
                from infrastructure.utils.swarm_skillbook import get_relevant_skills
...
"""
        ...
        try:
            from infrastructure.utils.langfuse_integration import evaluate_prompt_effectiveness
            from infrastructure.utils import flush_langfuse
        ...
        try:
            from infrastructure.utils.langfuse.cost_tracking import aggregate_costs_from_state, calculate_token_cost
        ...
        try:
            from analysis.agents.swarm_analysis_experience import store_swarm_experience, create_swarm_experience
            ...
            from infrastructure.utils.langfuse.cost_tracking import aggregate_costs_from_traces
            ...
            if experience_id:
                ...
                try:
                    from analysis.agents.swarm_analysis_skill_extraction import experience_to_skills
        ...
        try:
            from infrastructure.utils.swarm_skillbook import update_skill_usage
            from infrastructure.utils.skill_effectiveness import calculate_skill_effectiveness
