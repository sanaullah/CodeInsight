...
from workflow.swarm_analysis_state_decorators import validate_state_fields as validate_state_fields_decorator
from workflow.state_keys import StateKeys
from infrastructure.utils.validation import validate_project_path, validate_file_extensions
...
def scan_project_node(state: SwarmAnalysisState) -> SwarmAnalysisState:
    ...
    try:
        ...
        from indexing.scanners import create_project_scanner
        from indexing.scanners.language_detector import LanguageDetector
        from infrastructure.utils.langfuse_integration import create_observation
        ...
        try:
            ...
            if selected_dirs and len(selected_dirs) > 0:
                ...
                if enable_static_dependency_resolution:
                    try:
                        from indexing.dependency_resolver import DependencyResolver
            ...
            if files:
                from infrastructure.utils.io.file_hash import compute_file_hash
