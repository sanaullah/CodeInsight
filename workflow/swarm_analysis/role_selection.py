...
from workflow.swarm_analysis.architecture import summarize_architecture_for_roles
from workflow.swarm_analysis_roles import (
    RoleDefinition,
...
async def select_roles_node(state: SwarmAnalysisState, config: Optional[Dict[str, Any]] = None) -> SwarmAnalysisState:
    ...
    try:
        from infrastructure.utils.langfuse_integration import create_llm_observation
