...
def build_enhanced_system_prompt(architecture_hash: Optional[str] = None) -> str:
    ...
    """
    from infrastructure.utils.prompts.prompt_evidence_templates import get_confidence_level_guidance
    from infrastructure.utils.prompts.prompt_quality_checklists import get_universal_checklist, format_quality_checklist
    from infrastructure.utils.prompts.prompt_chunking_guidance import get_chunking_strategy
    ...
    base_prompt = f"""You are an expert at creating analysis prompts for AI code analysis analysis.agents.
...
def build_enhanced_user_prompt(
    ...
    """
    from infrastructure.utils.prompts.prompt_role_guidance import get_role_guidance
    from infrastructure.utils.prompts.prompt_persona_mapping import get_persona_for_role
    from infrastructure.utils.prompts.prompt_phase_context import get_phase_context
    from infrastructure.utils.prompts.prompt_chunking_guidance import get_chunking_strategy
    from infrastructure.utils.prompts.prompt_error_handling import get_error_handling_guidance
    from infrastructure.utils.prompts.prompt_evidence_templates import get_evidence_template
    from infrastructure.utils.prompts.prompt_quality_checklists import get_quality_checklist, format_quality_checklist
    from domain.architecture import ArchitectureModel
