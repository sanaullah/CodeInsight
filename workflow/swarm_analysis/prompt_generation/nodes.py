...
async def generate_single_prompt_node(state: SwarmAnalysisState, config: Optional[Dict[str, Any]] = None) -> SwarmAnalysisState:
    ...
    try:
        from infrastructure.utils.langfuse_integration import create_llm_observation, create_langfuse_prompt
        ...
        try:
            ...
            if architecture_hash and file_hash:
                from infrastructure.utils.langfuse.prompts import get_langfuse_prompt_by_metadata
                ...
                if existing_prompt:
                    ...
                    from infrastructure.utils.prompts.prompt_cache import cache_prompt
            ...
            from infrastructure.utils.prompts.prompt_cache import get_cached_prompt, cache_prompt
            cached_prompt = None
            if architecture_hash and file_hash:
            ...
            if architecture_hash:
                try:
                    from infrastructure.utils.prompts.prompt_storage import get_prompt_by_architecture_hash
            ...
            prompt_skills = []
            try:
                from infrastructure.utils.swarm_skillbook import get_skills
                from infrastructure.utils.skill_integration import format_skills_for_prompt
...
"""
            ...
            from infrastructure.utils.prompts.prompt_technology_filter import remove_hardcoded_technologies
            prompt = remove_hardcoded_technologies(prompt, architecture_model)
            
            # Run shared validation (lenient: warns but continues)
            from infrastructure.utils.prompts.prompt_validator import PromptValidator
