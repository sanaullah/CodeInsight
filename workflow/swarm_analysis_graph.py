...
from workflow.swarm_analysis_nodes import (
    scan_project_node,
...
from workflow.swarm_analysis.agent_execution.file_selection import select_agent_files_node
from workflow.swarm_analysis.previous_reports import load_previous_reports_node
...
def create_swarm_analysis_graph(
    ...
    def route_after_dispatch_prompts(state: SwarmAnalysisState):
        ...
        send_commands = []
        from workflow.swarm_analysis_send_builder import build_prompt_send_payload
    ...
    def route_after_dispatch_validation(state: SwarmAnalysisState):
        ...
        send_commands = []
        from workflow.swarm_analysis_send_builder import build_validation_send_payload
    ...
    def route_after_dispatch(state: SwarmAnalysisState):
        ...
        send_commands = []
        from workflow.swarm_analysis_send_builder import build_agent_send_payload
