...
All functionality has been moved to workflow.swarm_analysis package.

For new code, import directly from workflow.swarm_analysis:
    from workflow.swarm_analysis import scan_project_node, build_architecture_node, ...

This wrapper maintains backward compatibility for existing imports:
    from workflow.swarm_analysis_nodes import scan_project_node, ...
"""

# Re-export everything from the new package structure
from workflow.swarm_analysis import (
    # Project scanning
    scan_project_node,
    # Architecture
