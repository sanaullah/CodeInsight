...
def _get_storage():
    ...
    if _storage is None:
        try:
            from infrastructure.services.storage.cached_settings_storage import CachedSettingsStorage
            ...
            try:
                from infrastructure.services.storage.settings_storage import SettingsStorage
