...
def get_workflows_langfuse_callback(
    ...
    """
    Get a native Langfuse CallbackHandler for workflow.
    ...
    Example:
        from infrastructure.utils import get_workflows_langfuse_callback
...
def create_workflows_config(
    ...
    Example:
        from infrastructure.utils import create_workflows_config, get_workflows_langfuse_callback
