...
All functionality has been refactored into the infrastructure.utils.langfuse package.

For new code, prefer importing directly from infrastructure.utils.langfuse:
    from infrastructure.utils.langfuse import get_langfuse_client, create_langfuse_trace

This module re-exports all functions from infrastructure.utils.langfuse for backward compatibility.
"""
