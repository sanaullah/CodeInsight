...
# Import storage
try:
    from infrastructure.services.storage.cached_scan_history_storage import CachedScanHistoryStorage
    _storage = None
...
def serialize_planning_result(result: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        from analysis.agents.planning_models import (
            ExecutionPlan, Task, Findings, Issue, Warning, Recommendation,
            Priority, TaskStatus, PlanStatus, Severity
        )
        from analysis.agents.context_analyzer import ProjectContext
...
def _serialize_execution_plan(plan: 'ExecutionPlan') -> Dict[str, Any]:
    ...
    from analysis.agents.planning_models import ExecutionPlan
...
def _serialize_task(task: 'Task') -> Dict[str, Any]:
    ...
    from analysis.agents.planning_models import Task
...
def _serialize_findings(findings: 'Findings') -> Dict[str, Any]:
    ...
    from analysis.agents.planning_models import Findings
...
def _serialize_issue(issue: 'Issue') -> Dict[str, Any]:
    ...
    from analysis.agents.planning_models import Issue
...
def _serialize_warning(warning: 'Warning') -> Dict[str, Any]:
    ...
    from analysis.agents.planning_models import Warning
...
def _serialize_recommendation(rec: 'Recommendation') -> Dict[str, Any]:
    ...
    from analysis.agents.planning_models import Recommendation
