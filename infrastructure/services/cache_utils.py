...
def get_cache_key_for_record(
    service: str, record_id: str, prefix: Optional[str] = None
) -> str:
    """
...
def get_cache_key_for_query(
    ...
    query_data = {"filters": filters or {}, "limit": limit, "offset": offset}
...
def invalidate_related_keys(
    cache: Any, service: str, identifier: str, patterns: Optional[List[str]] = None
) -> int:
    """
