...
from infrastructure.utils.experience_storage import query_experiences, get_similar_experiences
...
def extract_learnings_from_experiences(
    ...
    try:
        ...
        try:
            from infrastructure.utils.prompts.prompt_analytics import get_best_prompts_for_role
...
def get_previous_report_from_experiences(
    ...
    try:
        ...
        from infrastructure.utils.report_loader import extract_synthesized_report_from_result
